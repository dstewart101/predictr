...
namespace Predictr.Controllers
{
    public class FixturesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,FixtureDateTime,HomeTeamId,HomeScore,AwayTeamId,AwayTeamScore,ResultId")] Fixture fixture)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FixtureDateTime,HomeTeamId,HomeScore,AwayTeamId,AwayTeamScore,ResultId")] Fixture fixture)
        {
            if (id != fixture.Id)
            {
                return NotFound();
